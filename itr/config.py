...
class Config:
    ...
    base_log_dir: str = '/content/drive/My Drive/Offnote labs/logs'
    base_output_dir: str = '/content/drive/My Drive/Offnote labs/output'
...
hc1 = Config(data='/content/drive/My Drive/Offnote labs/data/hin-eng/',
                    exp_name='default',
                    lang='hi',
                )
